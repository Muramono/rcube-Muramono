...
#     def test100_010_ShouldReturnCubeWithFaces(self):
#         expectedResult = {'cube': '111111111222222222333333333444444444555555555666666666'}
#         parms = {'op': 'create'}
#         actualResult = create._create(parms)
#         self.assertDictEqual(expectedResult, actualResult)

#     def test100_020_ShouldReturnCubeWithSHA(self):
...
#     def test100_030_ShouldReturnFacesWithInput(self):
...
#     def test100_040_ShouldReturnFacesNonNumerical(self):
...
## Test below are production acceptance test.
    ...
    def test200_010_ShouldReturnErrorBadLength(self):
        expectedResult = {'status': 'error: bad length'}
        parms = {'op': 'create', 'faces': 'ABCDE'}
        actualResult = create._create(parms)
        self.assertDictEqual(expectedResult, actualResult)

    def test200_020_ShouldReturnErrorDuplicate(self):
